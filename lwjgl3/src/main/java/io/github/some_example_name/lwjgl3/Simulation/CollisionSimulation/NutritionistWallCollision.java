...
/**
 * Resolves Nutritionist <-> Wall collisions.
 * FIX: uses n.getSpeed() instead of removed n.getBaseSpeed().
 */
public class NutritionistWallCollision {

    public static void resolve(Nutritionist n, Wall wall) {
        ...
        float spd      = n.getSpeed(); // FIX: was n.getBaseSpeed()
